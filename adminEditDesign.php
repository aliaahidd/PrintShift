<?php
    ...
    $query_confirm = "Select * from orders where orderStatus = 'Confirmed'";
...
<html>
  ...
  <div class="column middle">
    ...
    <?php 
            $id=$_GET["id"];
            $user_products_query="SELECT * FROM readymade where readymadeID = $id";
    ...
    <form method="post" action="adminUpdateDesign.php?id=<?php echo $row["readymadeID"]; ?>" enctype="multipart/form-data">
            <table>
                <tr>
                ...
                <td><p>Readymade Type</p></td>
                    <td><input type="text" name="readymadeType" value="<?php echo $row["readymadeType"];?>" class="form-control"></td>
                </tr>
                <tr>
                    <td><p>Readymade Name</p></td>
                    <td><input type="text" name="readymadeName" value="<?php echo $row["readymadeName"];?>" class="form-control"></td>
                </tr>
                <tr>
                    <td><p>Readymade Description</p></td>
                    <td><input type="text" name="readymadeDesc" value="<?php echo $row["readymadeDesc"];?>" class="form-control"></td>
                </tr>
                <tr>
  ...
  <div class="column side-right">
    ...
    <div id="box">
        <center>
            <div id=""><br><?php echo '<img src="data:image;base64,'.base64_encode( $row['readymadeImage'] ).'" id="display" style="width: 300px; height: 300px;">'?>
                <div class="myTarget" ></div>
            </div></center>      
    </div> <?php }} ?>
  </div>
  <input type="submit" value="Save" style="position: absolute; right: 120px; top:550px" class="btn btn-primary">
  </div>
  </form>
</body>
<script>
