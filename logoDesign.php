  ...
  <div class="column middle">
    ...
    <input type="text" id="myInput" placeholder=" Search for readymade design.." title="Type in a name">
           ...
           <?php
            ...
            $sql = "SELECT * FROM readymade where readymadeClass = 'Logo' LIMIT $start_from, $limit";  
...
$sql = "SELECT COUNT(readymadeID) FROM readymade where readymadeClass = 'Logo'" ;  
$rs_result = mysqli_query($con, $sql);  
...
for ($i=1; $i<=$total_pages; $i++) { 
            $pagLink .= "<a href='logoDesign.php?page=".$i."&proId=". $proId ."'>".$i."</a>";  
};  
echo $pagLink . "</div>";  
?>
    </div>
