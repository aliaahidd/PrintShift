...
<html>
    <head>
        ...
        <title>PrintShift | Order Confirm</title>
        <meta charset="UTF-8">
...
?>
    ...
    <p><?php echo '<img style="width: 40px; height: 40px; border-radius: 50%;" src="data:image;base64,'.base64_encode( $row['profileImage'] ).'" id="profImg">'?>
        ...
        <hr>
            ...
            <p><a style="color: #00A693;" href = "userHistory.php" >Order Confirm</a> <span style="background-color:#00A693; padding: 2px 5px; color: white;"><?php echo $_SESSION['countComplete']; ?></span></p>
 ...
 <div style="background-color: whitesmoke;  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
    <table>
        ...
        <td>
            ...
            ?>
            <form method="POST" action="postRating.php?id=<?php echo $row['orderID'];?>">
            <td><input type="submit" name="userReceived" value="Order Received" class="btn btn-primary"></td>
            </form>
...
$sql = "SELECT COUNT(orderID) FROM orders where  userID = '".$_SESSION['users_userID']."' and orderStatus = 'Confirmed'" ;  
...
//$color = $_GET['page'];  
    if($i == 1):?>
    <a href='userHistory.php?page=<?php echo $i;?>'><?php echo $i;?></a>
    <?php else:?>
    <a class="" href='userHistory.php?page=<?php echo $i;?>'><?php echo $i;?></a>
<?php endif;?>			
<?php endfor;endif; 
//echo $pagLink . "</div></center>";  
?>  
