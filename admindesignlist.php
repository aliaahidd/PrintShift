<?php
    ...
    $user_products_query="SELECT * FROM readymade order by readymadeID desc";
...
<html>
  ...
  <div class="column middle">
    <h2>Design</h2>
    <h4>Design List</h4><br>
    
    <table>
        <tr>
            <th>No.</th>
            <th>Readymade Image</th>
            <th>Readymade Class</th>
            <th>Readymade Type</th>
            <th>Readymade Name</th>
            <th>Readymade Description</th>
            <th>Edit</th>
            <th>Remove</th>
        </tr>
        ...
        <tr>
            ...
            <td><?php echo $row['readymadeID']?></td>
            <td><?php echo '<img src="data:image;base64,'.base64_encode( $row['readymadeImage'] ).'" id="" style="width: 100px; height: 100px;">'?></td>
            <td><?php echo $row['readymadeClass'];  ?></td>
            <td><?php echo $row['readymadeType'];  ?></td>
            <td><?php echo $row['readymadeName'];  ?></td>
            <td><?php echo $row['readymadeDesc'];  ?></td>

            <td><a href='adminEditDesign.php?id=<?php echo $row['readymadeID'] ?>' id="edit">Edit</a></td>
            <td><a href='design_remove.php?id=<?php echo $row['readymadeID'] ?>' id="remove">Remove</a></td>
        </tr>
...
$(function(){
    $('a#remove').click(function(){
        if(confirm('Are you sure to remove the design?')) {
            return true;
        }
