...
<div class="main">
  ...
  <div class="column middle">
    ...
    <?php
        ...
        $id=$_GET['id'];
        $proId = $_GET['proId'];   
            $display_query = "SELECT * FROM readymade WHERE readymadeID = '$id'";
            ...
            while($row = mysqli_fetch_array($display_result))  
                {
        ?>
    <form method="POST" action="cart_add.php?id=<?php echo $row["readymadeID"]; ?>&proId=<?php echo $proId ?>">     
    <div class="column">
        <div id="box" >
            <center><?php echo '<img src="data:image;base64,'.base64_encode( $row['readymadeImage'] ).'" id="" style="height: 300px; width:300px; padding-top: 20px;">'?><br><br>
           <h6>Readymade Code: <?php echo $row['readymadeID']?></h6> 
        </center></div>
    <?php }} ?>
    </div>                  
    </div>
  ...
  <div class="column side-right">
    <table>
        ...
        <tr>
            <td></td><td style="text-align: right;"><input type="submit" value="Add To Cart" name="rmBtn" class="btn btn-primary"></td>
        </tr>
