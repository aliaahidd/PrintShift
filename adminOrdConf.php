...
$sql = "SELECT COUNT(orderID) FROM orders where orderStatus = 'Confirmed' or orderStatus = 'Received' or orderStatus = 'Rated' ";  
...
for ($i=1; $i<=$total_pages; $i++) { 
            $pagLink .= "<a href='adminOrdConf.php?page=".$i."'>".$i."</a>";  
};  
echo $pagLink . "</div>";  
?>
    </div>
